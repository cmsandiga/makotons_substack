-- Create demo table for Part 3 article
CREATE TABLE users (
...
-- Insert sample data for Part 3 demonstrations
...
-- Add more users to create the B-tree structure for demonstrations
-- This creates the structure: ana@, bob@, carlos@ in left page
...
-- Add users for the middle page: clara@, luis@, maria@
INSERT INTO users (email, name, age, created_at) VALUES
    ('luis@example.com', 'Luis Garcia', 31, '2024-02-15');

-- Add users for the right page: pedro@, tom@, zoe@
INSERT INTO users (email, name, age, created_at) VALUES
